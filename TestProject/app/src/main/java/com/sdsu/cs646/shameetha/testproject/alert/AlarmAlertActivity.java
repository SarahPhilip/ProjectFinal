...
public class AlarmAlertActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		case EASY:
			mQuestions = new Questions(3);
			break;
		case MEDIUM:
			mQuestions = new Questions(4);
			break;
		case HARD:
			mQuestions = new Questions(5);
			break;
		}

		answerString = String.valueOf(mQuestions.getAnswer());
...
//		v.performHapticFeedback(HapticFeedbackConstants.VIRTUAL_KEY);
	...
	public boolean isAnswerCorrect() {
		...
		try {
			correct = mQuestions.getAnswer() == Float.parseFloat(answerBuilder
                    .toString());
